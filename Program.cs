        ...
        while (true)
        {
            ...
            switch (choice)
            {
                case "1":
                    ...
                    while (true)
                    {
                        Console.Write("Введите версию Word (целое число): ");
                        string inputVersion = Console.ReadLine();

                        if (int.TryParse(inputVersion, out wordVersion))                                //проверка на ввод целого числа (что б исключить эту ошибку)
                                                                                                        // фишку с проверкой подсмотрел на гите когда разбирался как вообще слепить мейн
                        {
                            break; 
                        }
                        else
                        {
                            Console.WriteLine("Ошибка: пожалуйста, введите целое число для версии Word.");
                        }
                    }
                ...
                while (true)
                {
                    ...
                    string inputEncryption = Console.ReadLine();

                    if (bool.TryParse(inputEncryption, out isEncrypted))
                    {
                        break;
                    }
                    else
            ...
            case "3":
                ...
                while (true)
                {
                    Console.Write("Введите количество листов (целое число): ");
                    string inputSheetCount = Console.ReadLine();

                    if (int.TryParse(inputSheetCount, out sheetCount) && sheetCount > 0)
                    {
                        break;
                    }
                    else
                    {
                        Console.WriteLine("Ошибка: пожалуйста, введите положительное целое число для количества листов.");
                    }
                }
            ...
            case "4":
                ...
                while (true)
                {
                    Console.Write("Введите количество символов (положительное целое число): ");
                    string inputCharCount = Console.ReadLine();

                    if (int.TryParse(inputCharCount, out charCount) && charCount > 0)
                    {
                        break; 
                    }
                    else
                    {
                        Console.WriteLine("Ошибка: пожалуйста, введите положительное целое число для количества символов.");
                    }
                }
            ...
            case "5":
                ...
                while (true)
                {
                    ...
                    string inputHasCSS = Console.ReadLine();

                    if (bool.TryParse(inputHasCSS, out hasCSS))
                    {
                        break; 
                    }
                    else
